...
import com.imatia.jee.bankmanager.server.dao.InvoicesTypeDao;
...
public class InvoicesService implements IInvoices {
	...
	@Autowired
	private InvoicesTypeDao invoicesTypeDao;
